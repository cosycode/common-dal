...
import com.github.cosycode.dal.source.DataSource;
import com.github.cosycode.dal.source.DataSourceAdapter;
...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        config.setUrl("jdbc:mysql://127.0.0.1:3306/my-project?useUnicode=true&zeroDateTimeBehavior=CONVERT_TO_NULL&serverTimezone=Hongkong&allowMultiQueries=true");
        config.setUser("root");
